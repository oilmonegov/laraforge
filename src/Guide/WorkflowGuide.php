    ...
    private function onboardingSteps(): array
    {
        return [
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge init',
                phase: 'setup',
                required: true,
                order: 2,
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge hooks:install',
                phase: 'setup',
                required: false,
                order: 3,
                prerequisite: 'init',
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge next --start feature',
                phase: 'complete',
                required: false,
                order: 4,
                prerequisite: 'init',
    ...
    private function featureSteps(): array
    {
        ...
        return [
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge prd:import <file> --create-feature',
                alternativeCommand: './vendor/bin/laraforge skill:run create-prd --params=title="'.$name.'"',
                phase: 'requirements',
                required: true,
                order: 1,
            ),
            new GuideStep(
                ...
                command: './vendor/bin/laraforge skill:run create-frd',
                phase: 'requirements',
                required: true,
                order: 2,
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge skill:run create-test-contract',
                phase: 'requirements',
                required: false,
                order: 3,
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge skill:run branch --params=type=feature',
                phase: 'development',
                required: true,
                order: 4,
                prerequisite: 'create-frd',
            ...
            new GuideStep(
                ...
                command: './vendor/bin/laraforge generate feature-test',
                phase: 'development',
                required: false,
                order: 5,
    ...
    private function bugfixSteps(): array
    {
        return [
            new GuideStep(
                ...
                command: './vendor/bin/laraforge skill:run branch --params=type=bugfix',
                phase: 'setup',
                required: true,
                order: 1,
            ),
    ...
    private function refactorSteps(): array
    {
        return [
            new GuideStep(
                ...
                command: './vendor/bin/laraforge skill:run branch --params=type=refactor',
                phase: 'setup',
                required: true,
                order: 1,
            ),
